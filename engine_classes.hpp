...
#pragma pack(4)
	...
	// 0x0700 (0x09FC - 0x02FC)
	class ATgDevice : public AActor
	{
	public:
		char                                               pad_0000[0x244];                                          // 0x0260(0x0244)
		int                                                r_nAmmoClipCount;                                         // 0x04A4(0x0004) (Net)
		char                                               pad_0001[0x168];                                          // 0x04A8(0x0178)
		...
		char                                               pad_0002[0x298];                                          // 0x0628(0x0298)
		struct FAccuracySettings                           m_AccuracySettings;                                       // 0x08C0(0x001C) (Edit)
		char                                               pad_0003[0x70];                                           // 0x08DC(0x0070)
		float                                              m_fCurrentAdvancedAccuracy;                               // 0x094C(0x0004)
		float                                              m_fLastShotTimestamp;                                     // 0x0950(0x0004)
		int                                                m_nFreeShotsLeft;                                         // 0x0954(0x0004)
		float                                              m_fLastMinAccuracy;                                       // 0x0958(0x0004)
		char                                               pad_0004[0x4];                                            // 0x095C(0x0004)
		struct FRecoilSettings                             m_RecoilSettings;                                         // 0x0960(0x0010) (Edit)
		char                                               pad_0005[0x40];                                           // 0x0970(0x0040)
		float                                              m_fStartFiringTimestamp;                                  // 0x09B0(0x0004)
		float                                              m_fEndFiringTimeStamp;                                    // 0x09B4(0x0004)
		float                                              m_fAccumulatedFiringTime;                                 // 0x09B8(0x0004)
		int                                                m_nRandRecoilNum;                                         // 0x09BC(0x0004) (Transient)
		int                                                r_nRecoilSeed;                                            // 0x09C0(0x0004) (Net, Transient)
	...
	public:
		...
		char                                               pad_0007[0x10c];                                          // 0x4ec (0x10c)
		int                                                r_ReplicatedDeviceState;									 // 0x05F8(0x0004) (Net)
		char                                               pad_0008[0x78];                                           // 0x05FC(0x0078)
